...
/**
 * Created by Mr_RexZ on 6/11/2016.
 */
public class C {
    ...
    public static final String INPUT_DETAILS = "INPUT_DETAILS";

    public static final String VIEW_MEMO_NOTIFICATION = "VIEW_MEMO_NOTIFICATION";
